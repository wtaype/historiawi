...
import{_ as b}from"./main-CizL1w6Z.js";import{j as l}from"./vendor-gzd0YkcT.js";import{b as o,e as w,w as y,a as k,N as C,g as u,s as $}from"./main-D-dBIy7l.js";import{db as v}from"./firebase-BVCWd-XR.js";import{u as I,d as g,i as T,a as A,g as R,q as F,l as D,o as E,w as h,c as U}from"./firebase-BmOP8wkl.js";const m="blog",x=12,P=6,_=a=>`wi_post_${a}`,f=a=>`wi_rel_${a}`,L=async(a,i=!1)=>{if(!i){const e=u(_(a));if(e)return{data:e,fromCache:!0}}const t=await A(g(v,m,a));if(!t.exists())return null;const s=t.data();return $(_(a),s,x),{data:s,fromCache:!1}},S=async(a,i,t=!1)=>{if(!t){const c=u(f(i));if(c)return c.filter(r=>r.id!==a).slice(0,3)}const e=(await R(F(U(v,m),h("activo","==",!0),h("categoria","==",i),E("creado","desc"),D(5))).catch(()=>null))?.docs.map(c=>c.data())||[];return e.length&&$(f(i),e,P),e.filter(c=>c.id!==a).slice(0,3)},Q=()=>`
  <div class="po_wrap">
    <div class="po_layout">
