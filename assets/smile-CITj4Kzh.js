import{j as s}from"./vendor-gzd0YkcT.js";import{auth as _,db as u}from"./firebase-xy2mMf8U.js";import{p as x,q as S,w as k,c as D,b as j,d as b,s as M,r as N}from"./firebase-BmOP8wkl.js";import{N as c,a as q,c as A,S as I,b as d,g as T}from"./main-BwmAh3eW.js";import"./main-Xk6liCy7.js";let o=[],m=null,r=null;const C="wi_notas_cache",p=()=>T("wiSmile")||{},H=a=>{try{localStorage.setItem(C,JSON.stringify(a))}catch{}},E=()=>{try{return JSON.parse(localStorage.getItem(C)||"[]")}catch{return[]}},z=()=>{const{nombre:a="",usuario:t="",email:e=""}=p(),i=a||t||e||_.currentUser?.email||"";return`
