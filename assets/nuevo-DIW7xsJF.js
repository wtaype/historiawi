const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-afWsqpZ7.js","assets/main-ChwGR5oC.js","assets/vendor-gzd0YkcT.js"])))=>i.map(i=>d[i]);
import{_ as P}from"./main-ChwGR5oC.js";import{j as a}from"./vendor-gzd0YkcT.js";import{e as y,N as r,f as w,M as S,b as g,g as j}from"./main-afWsqpZ7.js";import{db as b}from"./firebase-BJaYCV0a.js";import{g as D,d as k,u as I,s as T,a as M}from"./firebase-C6DIho6d.js";import{getPost as R,COL as $,clearPostCache as V,clearBlogCache as z}from"./devblog-Akxqqh5b.js";const N=["Animales","Naturaleza","Amor","Inspiración","Vida"],O=e=>e.trim().toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/\b(el|la|los|las|de|del|en|un|una|y|a|con|por|para|que|es|se)\b/g," ").replace(/[^a-z0-9\s]/g,"").replace(/\s+/g,"_").replace(/_{2,}/g,"_").replace(/^_|_$/g,"").slice(0,50),q=e=>{const t=e.replace(/<[^>]*>/g," ").split(/\s+/).filter(Boolean);return{words:t.length,min:Math.max(1,Math.ceil(t.length/200))}},L=()=>j.params()?.edit||new URLSearchParams(location.search).get("edit")||null,U=()=>{if(!y.user?.usuario)return'<div class="nu_err dpvc"><i class="fas fa-lock"></i><h2>Acceso restringido</h2><p>Inicia sesión para crear historias</p></div>';const e=y.user,t=L();return`
  <div class="nu_wrap">
    <div class="nu_head">
