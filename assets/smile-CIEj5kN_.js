import{j as s}from"./vendor-gzd0YkcT.js";import{auth as _,db as u}from"./firebase-BJaYCV0a.js";import{m as x,q as S,w as k,c as D,a as j,d as b,s as M,n as N}from"./firebase-C6DIho6d.js";import{N as c,a as q,c as A,S as I,b as d,h as T}from"./main-afWsqpZ7.js";import"./main-ChwGR5oC.js";let o=[],m=null,r=null;const C="wi_notas_cache",p=()=>T("wiSmile")||{},H=a=>{try{localStorage.setItem(C,JSON.stringify(a))}catch{}},E=()=>{try{return JSON.parse(localStorage.getItem(C)||"[]")}catch{return[]}},z=()=>{const{nombre:a="",usuario:t="",email:e=""}=p(),i=a||t||e||_.currentUser?.email||"";return`
