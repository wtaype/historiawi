      ...
      <div class="po_wrap"><div class="po_layout">
        ...
        <aside class="po_sidebar">
          <div class="po_side_card po_fade" style="--d:.15s">
            ...
            <div class="po_autor_box"><div class="po_autor_av"><img src="/historiawi/logo.webp" alt="${a.autor}"/></div><div class="po_autor_info"><strong>${a.autor}</strong><span>Historiawi 🐾</span></div></div>
          </div>
