...
import{_ as M}from"./main-Xk6liCy7.js";import{j as a}from"./vendor-gzd0YkcT.js";import{e as c,N as r,f as b,M as P,b as f}from"./main-BwmAh3eW.js";import{db as h}from"./firebase-xy2mMf8U.js";import{a as E,d as x,s as A,b as S}from"./firebase-BmOP8wkl.js";const q=["Animales","Naturaleza","Amor","Inspiración","Vida"],k="blog",I=n=>n.trim().toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/\b(el|la|los|las|de|del|en|un|una|y|a|con|por|para|que|es|se)\b/g," ").replace(/[^a-z0-9\s]/g,"").replace(/\s+/g,"_").replace(/_+/g,"_").replace(/^_|_$/g,"").slice(0,50),L=n=>{const e=n.replace(/<[^>]*>/g," "),l=Math.ceil(e.split(/\s+/).filter(Boolean).length/200);return`${Math.max(1,l)} min`},V=()=>c.user?.usuario?`
  <div class="nu_wrap">
